...
execute if score @s chestRandom matches 1..1000 if score @s stoneBroken matches 1.. run execute at @s anchored eyes positioned ^ ^ ^0.5 run function samslootboxes:broken/recurse
execute if score @s chestRandom matches 1..1000 if score @s deepslateBroken matches 1.. run execute at @s anchored eyes positioned ^ ^ ^0.5 run function samslootboxes:broken/recurse
execute if score @s chestRandom matches 1..1000 if score @s netherrackBroken matches 1.. run execute at @s anchored eyes positioned ^ ^ ^0.5 run function samslootboxes:broken/recurse
execute if score @s chestRandom matches 1..1000 if score @s endstoneBroken matches 1.. run execute at @s anchored eyes positioned ^ ^ ^0.5 run function samslootboxes:broken/recurse
